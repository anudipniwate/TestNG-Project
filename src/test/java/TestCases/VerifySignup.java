...
public class VerifySignup extends BaseClass {
	...
	public void signup() throws IOException, InterruptedException {
		 ...
		 * s.selectByIndex(7); // SPO.SelectJobTitle().click();
		 * 
		 * // SPO.SelectEmployees().click(); WebElement EMP = SPO.SelectEmployees();
		 * Select s2 = new Select(EMP); s2.selectByIndex(3);
		 * 
		 * WebElement CNTRY = SPO.SelectCountry(); Select s1 = new Select(CNTRY);
		 * s1.selectByIndex(0);
		 */
	}
